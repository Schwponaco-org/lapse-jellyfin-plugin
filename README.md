...
- **Readable Subtitles** - writes a copy with a dyslexia-friendly font, larger text and wider letter spacing set inside the file rather than in a client. The font itself installs from the dashboard under Subtitle appearance.
